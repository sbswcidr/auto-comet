...
public class JsonModelAndView extends ModelAndView {
	...
	{
		this.setViewName(DEFAULT_VIEW_NAME);
	}
	 ...
	 * @see #addObject
	 */
	public JsonModelAndView(String viewName) {
		this.view = viewName;
	}
	 ...
	 * @see #addObject
	 */
	public JsonModelAndView(View view) {
		this.view = view;
	}
	 ...
	 *            entries may not be <code>null</code>, but the model Map may be
	 *            <code>null</code> if there is no model data.
	 */
	public JsonModelAndView(String viewName, Map<String, ?> model) {
		this.view = viewName;
		if (model != null) {
	 ...
	 *            <code>null</code> if there is no model data.
	 */
	public JsonModelAndView(View view, Map<String, ?> model) {
		this.view = view;
		if (model != null) {
			getModelMap().addAllAttributes(model);
		}
	 ...
	 */
	public JsonModelAndView(String viewName, String modelName,
			Object modelObject) {
		this.view = viewName;
	 ...
	 *            the single model object
	 */
	public JsonModelAndView(View view, String modelName, Object modelObject) {
		this.view = view;
		addObject(modelName, modelObject);
	}
	 ...
	 * ViewResolver, or <code>null</code> if we are using a View object.
	 */
	...
	/**
	 * Set a View object for this ModelAndView. Will override any pre-existing
	 * view name or View.
	 */
	...
	/**
	 * Return whether we use a view reference, i.e. <code>true</code> if the
	...
	/**
	 * Return the model map. May return <code>null</code>. Called by
	 * DispatcherServlet for evaluation of the model.
	 */
	...
	/**
	 * Return the underlying <code>ModelMap</code> instance (never
	 * <code>null</code>).
	 */
	public ModelMap getModelMap() {
		if (this.model == null) {
			this.model = new JsonModelMap();
		}
		return this.model;
	}
	 ...
	 *            object to add to the model (never <code>null</code>)
	 ...
	 * 
	 * @param attributeValue
	 *            the object to add to the model (never <code>null</code>)
	...
	/**
	 * Clear the state of this ModelAndView object. The object will be empty
	 * afterwards.
	 * <p>
	...
	/**
	 * Return whether this ModelAndView object is empty, i.e. whether it does
	 ...
	 * {@link #clear} i.e. whether it does not hold any view and does not
	 * contain a model.
	 * <p>
	 * Returns <code>false</code> if any additional state was added to the
	...
	public String toString() {
		...
		if (isReference()) {
			sb.append("reference to view with name '").append(this.view)
					.append("'");
		} else {
